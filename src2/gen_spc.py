...
# RST pulse after all operations complete (1:1 with MAIN SET)
a("LD", "M824"); a("RST", "M824")
...
# RST pulse after all operations complete (1:1 with MAIN SET)
a("LD", "M840"); a("RST", "M840")

# ===== DISPLAY BOMBE =====
al("DISPLAY BOMBE")
a("LD", "M0"); a("MOV", "D282"); ac("D88")
# M875: L0 bombe count exceed (1:1 SET here, RST in alarm.csv via M1027)
a("LDD>=", "D280"); ac("D14"); a("SET", "M875")
# M878: L1 bombe count exceed (1:1 SET here, RST in alarm.csv via M1027)
a("LDD>=", "D290"); ac("D14"); a("SET", "M878")
...
a("END","")
wr("F:\\WorkSpace\\REF\\src2\\spc.csv")
