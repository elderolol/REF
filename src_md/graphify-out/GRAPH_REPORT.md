# Graph Report - src_md  (2026-06-03)

## Corpus Check
- 26 files · ~54,902 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2747 nodes · 2709 edges · 446 communities (443 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c409e87f`
...
## Communities (446 total, 3 thin omitted)
...
Cohesion: 0.40
Nodes (4): device_map, blocks, test_cases, warnings
...
## Knowledge Gaps
- **2239 isolated node(s):** `source_file`, `cpu`, `total_steps`, `block_count`, `generated` (+2234 more)
