# Graph Report - src_md  (2026-06-02)

## Corpus Check
- 24 files · ~47,542 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2621 nodes · 2597 edges · 432 communities (430 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f7ac0ca7`
...
1. `device_map` - 83 edges
2. `device_map` - 83 edges
3. `device_map` - 37 edges
4. `device_map` - 35 edges
5. `device_map` - 32 edges
6. `device_map` - 28 edges
7. `device_map` - 26 edges
8. `device_map` - 25 edges
9. `device_map` - 19 edges
10. `device_map` - 14 edges
...
## Communities (432 total, 2 thin omitted)
...
Cohesion: 0.29
Nodes (6): Block 1: GUN VACUUM (Line 0) (Step 0–35), Block 2: GUN VACUUM (Line 1) (Step 36–72), Block Detail, Block List, gunvac — IL Logic Map, Device Map

### Community 9 - "Community 9"
Cohesion: 0.29
Nodes (6): Block 1: UNIT VACUUM (Line 0) (Step 0–39), Block 2: UNIT VACUUM (Line 1) (Step 40–80), Block Detail, Block List, Device Map, unitvac — IL Logic Map
...
Cohesion: 0.33
Nodes (6): out_steps, read_steps, rst_steps, set_steps, type, D154
...
Cohesion: 0.33
Nodes (6): out_steps, read_steps, rst_steps, set_steps, type, D140
...
Cohesion: 0.33
Nodes (6): out_steps, read_steps, rst_steps, set_steps, type, D148
...
Cohesion: 0.33
Nodes (6): T0, out_steps, read_steps, rst_steps, set_steps, type
...
Cohesion: 0.33
Nodes (6): L1, out_steps, read_steps, rst_steps, set_steps, type
...
Cohesion: 0.33
Nodes (6): T4, out_steps, read_steps, rst_steps, set_steps, type
...
Cohesion: 0.33
Nodes (6): out_steps, read_steps, rst_steps, set_steps, type, D64
...
Cohesion: 0.33
Nodes (6): out_steps, read_steps, rst_steps, set_steps, type, D128
...
Cohesion: 0.33
Nodes (6): out_steps, read_steps, rst_steps, set_steps, type, D280

### Community 365 - "Community 365"
Cohesion: 0.33
Nodes (6): out_steps, read_steps, rst_steps, set_steps, type, D282
...
Cohesion: 0.33
Nodes (6): T1, out_steps, read_steps, rst_steps, set_steps, type
...
Cohesion: 0.33
Nodes (6): out_steps, read_steps, rst_steps, set_steps, type, D308
...
Cohesion: 0.33
Nodes (6): T2, out_steps, read_steps, rst_steps, set_steps, type
...
## Knowledge Gaps
- **2153 isolated node(s):** `source_file`, `cpu`, `total_steps`, `block_count`, `generated` (+2148 more)
