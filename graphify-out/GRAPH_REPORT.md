...
## Corpus Check
- Corpus is ~30,922 words - fits in a single context window. You may not need a graph.
...
- [[_COMMUNITY_HMI Screen & Function Buttons|HMI Screen & Function Buttons]]
- [[_COMMUNITY_PLC Module Functions (CSV)|PLC Module Functions (CSV)]]
- [[_COMMUNITY_Explosion-Proof & Door Alarm|Explosion-Proof & Door Alarm]]
- [[_COMMUNITY_System Configuration & Layout|System Configuration & Layout]]
- [[_COMMUNITY_2-Line Operation Screen|2-Line Operation Screen]]
- [[_COMMUNITY_HMI System Interface|HMI System Interface]]
- [[_COMMUNITY_Data Flow & Register Map|Data Flow & Register Map]]
- [[_COMMUNITY_IL CSV Format Specification|IL CSV Format Specification]]
- [[_COMMUNITY_PLC IO & Interlock System|PLC I/O & Interlock System]]
- [[_COMMUNITY_Door Alarm Design Decision|Door Alarm Design Decision]]
- [[_COMMUNITY_Ladder Logic & IL Mnemonics|Ladder Logic & IL Mnemonics]]
- [[_COMMUNITY_Injection Process Flow|Injection Process Flow]]
- [[_COMMUNITY_Alarm Latch & Buzzer Control|Alarm Latch & Buzzer Control]]
- [[_COMMUNITY_Address Map & Data Exchange|Address Map & Data Exchange]]
- [[_COMMUNITY_GMES Sequence Controller|GMES Sequence Controller]]
- [[_COMMUNITY_Process Step Sequences|Process Step Sequences]]
- [[_COMMUNITY_PC Communication Area|PC Communication Area]]
- [[_COMMUNITY_Device Range Summary|Device Range Summary]]
- [[_COMMUNITY_ManualAuto Mode Control|Manual/Auto Mode Control]]
- [[_COMMUNITY_Gun & Line Selection|Gun & Line Selection]]
- [[_COMMUNITY_Safety & Interlock Logic|Safety & Interlock Logic]]
- [[_COMMUNITY_Result & Process Codes|Result & Process Codes]]
- [[_COMMUNITY_PC to PLC Ethernet Data|PC to PLC Ethernet Data]]
- [[_COMMUNITY_Timer & Counter Allocation|Timer & Counter Allocation]]
- [[_COMMUNITY_HSC & Pulse Counting|HSC & Pulse Counting]]
- [[_COMMUNITY_Barcode Data & Model Lookup|Barcode Data & Model Lookup]]
- [[_COMMUNITY_Emergency Stop Priority|Emergency Stop Priority]]
- [[_COMMUNITY_SPC & Accumulated Data|SPC & Accumulated Data]]
...
### Community 0 - "HMI Screen & Function Buttons"
Cohesion: 0.05
...
### Community 1 - "PLC Module Functions (CSV)"
Cohesion: 0.06
...
### Community 2 - "Explosion-Proof & Door Alarm"
Cohesion: 0.05
...
### Community 3 - "System Configuration & Layout"
Cohesion: 0.04
...
### Community 4 - "2-Line Operation Screen"
Cohesion: 0.06
...
### Community 5 - "HMI System Interface"
Cohesion: 0.09
...
### Community 6 - "Data Flow & Register Map"
Cohesion: 0.08
...
### Community 7 - "IL CSV Format Specification"
Cohesion: 0.1
...
### Community 8 - "PLC I/O & Interlock System"
Cohesion: 0.12
...
### Community 9 - "Door Alarm Design Decision"
Cohesion: 0.21
...
### Community 10 - "Ladder Logic & IL Mnemonics"
Cohesion: 0.15
...
### Community 11 - "Injection Process Flow"
Cohesion: 0.23
...
### Community 12 - "Alarm Latch & Buzzer Control"
Cohesion: 0.17
...
### Community 13 - "Address Map & Data Exchange"
Cohesion: 0.2
...
### Community 14 - "GMES Sequence Controller"
Cohesion: 0.25
...
### Community 15 - "Process Step Sequences"
Cohesion: 0.25
Nodes (8): 6-2. Basic Instructions (confirmed in MAIN.csv + MELSEC manual), 6-3. Notation Rules, 6. Instruction Mnemonics, 7-1. Observed device prefixes, 7. Device / Operand Notation, Comparison Instructions, Program Control Instructions, Transfer / Arithmetic / Conversion Instructions

### Community 16 - "PC Communication Area"
Cohesion: 0.25
...
### Community 17 - "Device Range Summary"
Cohesion: 0.33
...
### Community 18 - "Manual/Auto Mode Control"
Cohesion: 0.5
...
### Community 19 - "Gun & Line Selection"
Cohesion: 0.4
Nodes (5): 6-1. Sequence Instructions (confirmed in MAIN.csv + MELSEC manual), Association Instructions, Contact Instructions (Load / AND / OR), Output Instructions, Shift / Master Control / Termination

### Community 20 - "Safety & Interlock Logic"
Cohesion: 0.5
...
- **What is the exact relationship between `Line 2 (라인2)` and `인터락 미사용 (Interlock Not Used) Button`?**
  _Edge tagged AMBIGUOUS (relation: safety_override) - confidence is low._
- **Why does `PLC Program Structure Design` connect `Explosion-Proof & Door Alarm` to `PLC I/O & Interlock System`, `Injection Process Flow`, `HMI System Interface`, `Data Flow & Register Map`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `REFRIGER CHARGING MACHINE` connect `Explosion-Proof & Door Alarm` to `HMI System Interface`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `REFRIGER_CHARGING_MACHINE.md HMI Specification` connect `HMI System Interface` to `Door Alarm Design Decision`, `Explosion-Proof & Door Alarm`?**
